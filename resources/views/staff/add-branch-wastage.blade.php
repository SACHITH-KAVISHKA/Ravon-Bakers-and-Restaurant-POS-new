...
@section('title', 'Add Branch Wastage')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 fw-bold text-dark">Add Branch Wastage</h1>
        </div>
    </div>
</div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom">
                <h5 class="card-title mb-0">
                    ...
                    Branch Wastage Record Form
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('staff.store-branch-wastage') }}" method="POST" id="wastageForm">
                    @csrf
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('staff.branch-inventory') }}" class="btn btn-outline-secondary">
                            <i class="bi bi-arrow-left"></i> Back to Branch Inventory
                        </a>
                        <button type="submit" class="btn btn-danger">
                            <i class="bi bi-trash"></i> Record Branch Wastage
                        </button>
                    </div>
                </form>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('addAllItemsBtn').addEventListener('click', function() {
            ...
            if (window.wastageItems && Array.isArray(window.wastageItems) && window.wastageItems.length > 0) {
                ...
                alert('No items available. Please check if items exist in the branch inventory.');
            }
