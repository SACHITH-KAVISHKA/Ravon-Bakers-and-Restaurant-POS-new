...
@section('title', 'Branch Wastage Records')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 fw-bold text-dark">Branch Wastage Records</h1>
        </div>
    </div>
</div>
...
<div class="row mb-4">
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('staff.branch-wastage-view') }}">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <a href="{{ route('staff.branch-wastage-view') }}" class="btn btn-outline-secondary btn-sm">
...
<div class="row">
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom">
                <h6 class="card-title mb-0">
                    <i class="bi bi-list-ul"></i> Branch Wastage Records
                </h6>
            </div>
            <div class="card-body">
                @if($wastages->count() > 0)
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted mt-3">No branch wastage records found</h5>
                        <p class="text-muted">
                            @if(request()->hasAny(['date_from', 'date_to', 'item_name']))
                                Try adjusting your filters or 
                                <a href="{{ route('staff.branch-wastage-view') }}">clear all filters</a>
                            @else
                                Start by <a href="{{ route('staff.add-branch-wastage') }}">adding a branch wastage record</a>
                            @endif
                        </p>
                    </div>
                @endif
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="wastageModalLabel{{ $wastage->id }}">
                        <i class="bi bi-trash"></i> Branch Wastage Details - {{ $wastage->date_time->format('M d, Y H:i') }}
                    </h5>
