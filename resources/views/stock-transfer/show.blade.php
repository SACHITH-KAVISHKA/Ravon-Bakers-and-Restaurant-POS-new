    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('stock-transfer.transfers') }}" class="btn btn-outline-secondary">
                <i class="bi bi-arrow-left"></i> Back to All Stock Transfers
            </a>
        </div>
    </div>
</div>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="modal fade" id="acceptModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{ route('stock-transfer.accept', $stockTransfer) }}" method="POST">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title">
                                ...
                                <div class="modal-body">
                                    <p>Are you sure you want to accept the stock transfer from <strong>{{ $stockTransfer->source_name }}</strong>?</p>
                                </div>
                                <div class="modal-footer">
